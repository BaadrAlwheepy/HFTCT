...
def Classifier(): 
    global NegPercentage, PosPercentage #importing global variables
...
def ResultsWindow(): # a window function for results
    ...
    SaveResultsBtn.place(relx= 0.2, rely= 0.9 ,height=40, width=200)
    ...
    ViewTweetsBtn.place(relx= 0.51, rely= 0.9 ,height=40, width=200)
...
def HFTCTMainWindow(): 
    ...
    command= lambda:[ EntryCheck(KeyWordEntry.get())])
